...
#ifdef USE_BYONLINE
		// If we're reading var586, playing online, successfully fetched custom teams,
		// and we're not in one of the three scripts that cause bugs if 263 is returned here,
		// return 263
		if (
